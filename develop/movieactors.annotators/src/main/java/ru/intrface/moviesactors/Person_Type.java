...
public class Person_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("ru.intrface.moviesactors.Person");
  ...
  public String getName(int addr) {
      ...
      jcas.throwFeatMissing("name", "ru.intrface.moviesactors.Person");
